...
class Lead(models.Model):
    ...
    status = models.CharField(choices=STATUS, default='PENDING', max_length=100,null=True, blank=True)
    con_paybal_revenue=models.DecimalField(max_digits=15,decimal_places=0,default=0,null=False)
    con_paid_revenue=models.DecimalField(max_digits=15,decimal_places=0,default=0,null=True, blank=True)
    trx_date=models.DateField(default=timezone.now)
    trx_no=models.CharField(max_length=254,default=0)
    con_revenue_status=models.CharField(choices=REVENUE_STATUS, default='PENDING', max_length=100,null=True, blank=True)
